...
#**用来指定压缩的类型，“text/html”类型总是会被压缩**
  ...
  #vary header**支持。该选项可以让前端的缓存服务器缓存经过GZIP压缩的页面，例如用**
...
#upstream**表示负载服务器池，定义名字为backend_server的服务器池**
...
if ($query_string ~ "[a-zA-Z0-9]=/([a-z0-9.]//?)+") {
...
if ($query_string ~ "mosConfig[a-zA-Z]{1,21}(=|\%3D)") {
